	  ...
	  <div class="container">
	    <div class="row">
	      <div class="col-md-4 col-sm-12 footer-widget">
	        ...
	        <div class="latest-post-items media">
	          <div class="latest-post-content media-body">
	            ...
	            <p class="post-meta">
	              <span class="date"><i class="icon icon-calendar"></i> Mar 15, 2020</span>
	        ...
	        <div class="latest-post-items media">
	          <div class="latest-post-content media-body">
	            ...
	            <p class="post-meta">
	              <span class="date"><i class="icon icon-calendar"></i> Apr 17, 2020</span>
	      ...
	      <div class="col-md-3 col-sm-12 footer-widget footer-about-us">
	        ...
	        <h4>Address</h4>
	        <p>1004 Surat Dell, Function City, GJ</p>
	        <div class="row">
	          <div class="col-md-6">
	            <h4>Email:</h4>
	            <p>in@bigcraft.com</p>
	    ...
	    <div class="row">
	      <div class="col-md-12 text-center">
	        <div class="copyright-info">
	          &copy; Copyright <?php echo date('Y'); ?> 88innovations Engineering Ltd. <span> Designed & Developed by <a
	              href="#">Saif Power Group - Software Team</a></span>
	        </div>
	      </div>
	    </div>
	    <!--/ Row end -->
